...
predictions = model.transform(df4) \
                    ...
                    .selectExpr("CAST(value AS STRING)","prediction", 'topic')

df_activity = predictions.filter("prediction == 1") #.drop('pir_class')

checkpoint_dir = "file:///tmp/streaming/realtime_activity_prediction_activity"
